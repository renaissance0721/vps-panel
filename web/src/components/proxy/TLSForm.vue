...
<template>
<label><span>TLS 证书来源</span><select v-model="proxyTLSMode" class="settings-input"><option value="acme" :disabled="!proxyTLSACMESupported">自动申请（推荐）</option><option value="manual" :disabled="!proxyTLSManualSupported">手动证书</option></select></label>
